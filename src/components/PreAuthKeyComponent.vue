<template>
  <q-card class="card-center" style="height: calc(100vh - 300px)">
    <q-card-section class="row justify-between items-center">
      <div class="text-h6">PreAuthKeys Management</div>

      <q-btn class="q-ml-auto" icon="close" round flat v-close-popup />
    </q-card-section>
    <q-card-section>
      <q-btn
        icon="add"
      ...
      <q-scroll-area style="height: calc(100vh - 500px)" class="q-pa-md">
        <q-card flat bordered class="rounded-borders q-mb-sm" v-if="addKey">
          <q-card-section class="q-py-sm">
            <div class="row justify-between items-center">
              ...
              <q-btn icon="check" color="positive" round flat dense />
            </div>
            ...
            <div style="max-width: 300px" class="q-mt-md">
              <q-input filled v-model="expiration">
          ...
          <q-card flat bordered class="rounded-borders q-mb-sm">
            <q-card-section class="q-py-sm">
              ...
              <div class="text-secondary">
                <span class="text-primary text-weight-medium q-mr-xs">Key:</span
                >{{ pre_auth_key.key }}
              </div>
              <div class="text-secondary">
                <span class="text-primary q-mr-xs text-weight-medium"
                  >Expiration:</span
                >
